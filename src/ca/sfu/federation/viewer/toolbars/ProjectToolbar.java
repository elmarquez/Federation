...
import ca.sfu.federation.action.CreateProjectAction;
import ca.sfu.federation.action.OpenProjectAction;
import ca.sfu.federation.action.SaveProjectAction;
 ...
 * @author dmarques
 */
public class ProjectToolbar extends LineDock {
    ...
    private void init() {
        ...
        Dockable btn1 = createButtonDockable("NewProject", new CreateProjectAction());
        Dockable btn2 = createButtonDockable("OpenProject", new OpenProjectAction());
        Dockable btn3 = createButtonDockable("SaveProject", new SaveProjectAction());
        Dockable btn4 = createButtonDockable("ButtonDockableAdd", new MessageAction(this,"Action!",ImageIconUtils.loadIconFromPath("/ca/sfu/federation/resources/icons/16x16/apps/utilities-system-monitor.png"),"Action!"));
        Dockable btn5 = createButtonDockable("ButtonDockableAdd", new MessageAction(this,"Action!",ImageIconUtils.loadIconFromPath("/ca/sfu/federation/resources/icons/16x16/apps/utilities-system-monitor.png"),"Action!"));
        Dockable btn6 = createButtonDockable("ButtonDockableAdd", new MessageAction(this,"Action!",ImageIconUtils.loadIconFromPath("/ca/sfu/federation/resources/icons/16x16/apps/utilities-system-monitor.png"),"Action!"));
        // add items to list
        items.add(btn1);
        items.add(btn2);
        items.add(btn3);
