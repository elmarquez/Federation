 ...
 * @author dmarques
 */
public class ModelingToolbar extends LineDock {

    /**
     * ProjectToolbar default constructor
     */
    public ModelingToolbar() {
    ...
    private void init() {
        ...
        Dockable btn1 = createButtonDockable("model-new-scenario", new CreateScenarioAction());
        Dockable btn2 = createButtonDockable("model-new-assembly", new CreateAssemblyAction());
        Dockable btn3 = createButtonDockable("model-new-component", new CreateComponentAction());
        Dockable btn4 = createButtonDockable("model-new-behavior", new CreateBehaviorAction());
        Dockable btn5 = createButtonDockable("model-new-point", new EditPasteAction());
        Dockable btn6 = createButtonDockable("model-new-line", new EditDeleteAction());
        Dockable btn7 = createButtonDockable("model-new-rectnagle", new EditDeleteAction());
        Dockable btn8 = createButtonDockable("model-new-ellipse", new EditDeleteAction());
        // add items to list
        items.add(btn1);
        items.add(btn2);
        items.add(btn3);
