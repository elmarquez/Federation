 ...
 * @version 0.1.0
 */
public class ParametricModelRenameAction extends AbstractAction {
     ...
     */
    public ParametricModelRenameAction(String Name, Icon MyIcon, String ToolTip, Integer MnemonicId) {
        super(Name,MyIcon);
