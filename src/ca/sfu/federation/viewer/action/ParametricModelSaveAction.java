 ...
 * @version 0.1.0
 */
public class ParametricModelSaveAction extends AbstractAction {
     ...
     */
    public ParametricModelSaveAction(String Name, Icon MyIcon, String ToolTip, Integer MnemonicId) {
        super(Name, MyIcon);
