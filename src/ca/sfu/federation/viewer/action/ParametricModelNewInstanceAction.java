 ...
 * @version 0.1.0
 */
public class ParametricModelNewInstanceAction extends AbstractAction {
     ...
     */
    public ParametricModelNewInstanceAction(String Name, Icon MyIcon, String ToolTip, Integer MnemonicId) {
        super(Name, MyIcon);
