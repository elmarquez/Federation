 ...
 * @version 0.1.0
 */
public class INamedObjectDeleteAction extends AbstractAction {
     ...
     */
    public INamedObjectDeleteAction(String Name, Icon MyIcon, String ToolTip, Integer MnemonicId, INamed MyTarget) {
        super(Name, MyIcon);
