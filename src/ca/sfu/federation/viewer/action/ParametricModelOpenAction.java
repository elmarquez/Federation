 ...
 * @version 0.1.0
 */
public class ParametricModelOpenAction extends AbstractAction {
     ...
     */
    public ParametricModelOpenAction(String Name, Icon MyIcon, String ToolTip, Integer MnemonicId) {
        super(Name, MyIcon);
