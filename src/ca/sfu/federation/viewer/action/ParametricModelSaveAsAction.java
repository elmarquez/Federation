 ...
 * @version 0.1.0
 */
public class ParametricModelSaveAsAction extends AbstractAction {
     ...
     */
    public ParametricModelSaveAsAction(String Name, Icon MyIcon, String ToolTip, Integer MnemonicId) {
        super(Name, MyIcon);
