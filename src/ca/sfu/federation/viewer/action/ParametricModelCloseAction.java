 ...
 * @version 0.1.0
 */
public class ParametricModelCloseAction extends AbstractAction {
     ...
     */
    public ParametricModelCloseAction(String Name, Icon MyIcon, String ToolTip, Integer MnemonicId) {
        super(Name, MyIcon);
