 ...
 * @version 0.1.0
 */
public class RenameINamedAction extends AbstractAction {
    ...
    /**
     * RenameINamedAction constructor.
     * 
     ...
     */
    public RenameINamedAction(String Name, Icon MyIcon, String ToolTip, Integer MnemonicId, INamed Named) {
        super(Name, MyIcon);
