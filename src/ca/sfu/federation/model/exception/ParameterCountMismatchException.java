/*
 * ParameterCountMismatchException.java
...
/**
 * The number of parameters in the expression does not match the operator signature.
...
public class ParameterCountMismatchException extends Exception {
    ...
    public ParameterCountMismatchException(String msg) {
        super(msg);
    }
